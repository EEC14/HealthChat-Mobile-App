            ...
            <View className="items-center justify-center flex-1 p-10 bg-gray-200 bg-opacity-50">
              ...
              <ScrollView className="max-h-100">
                <Text className="text-gray-600 dark:text-gray-400">
                  ...
                  limited to, identifying information such as names, contact
                  details, and other information submitted during use.
                  Interaction Data: Includes all data entered into the chatbot,
                  including sensitive or non-sensitive data. Technical Data:
                  ...
                  permissions. 4. Legal Basis for Processing The legal basis for
                  processing data is determined on a case-by-case basis and may
                  include user consent, performance of a contract, compliance
                  with legal obligations, or legitimate interests pursued by the
                  business. 5. Data Sharing and Transfers We may share or
                  transfer data to: Third-party service providers, vendors, or
                  contractors for operational purposes. Affiliates, business
                  partners, and advertisers. Governmental authorities as
                  required by law Buyers or successors in the event of a
                  business sale, merger, or acquisition. Where data is
                  transferred outside the EEA, appropriate safeguards such as
                  Standard Contractual Clauses may apply. 6. Retention of Data
                  Data will be retained for as long as necessary to fulfill the
                  purposes for which it was collected or for longer periods
                  where legally required or operationally advantageous. 7.
                  Cookies and Tracking Technologies We may use cookies, web
                  beacons, and other tracking technologies to collect data about
                  user behavior and preferences. Users can manage or restrict
                  cookies via their browser settings. 8. User Rights Users may
                  have rights under applicable law, such as: Accessing their
                  data. Requesting rectification or deletion of data (where
                  feasible). Objecting to or restricting certain processing
                  activities. Requests must be submitted via e-mail, and we
                  reserve the right to deny requests where legally permissible.
                  9. Data Security While we implement standard security
                  measures, no system is completely secure. Users acknowledge
                  and accept that the provision of data is at their own risk.
                  10. Changes to This Policy We reserve the right to update or
                  modify this policy at any time without prior notice. The
                  latest version will be published on the website or Service.
                  Continued use of the Service constitutes acceptance of the
                  updated terms. 11. Contact Information For inquiries regarding
                  this Privacy Policy, contact: Email:
                  compliance@esbhealthcare.com Address: 1 Maple Road, Stockport
                  SK7 2DH, GB
                </Text>
              </ScrollView>
